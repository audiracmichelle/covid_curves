...
```{r}
fit = read_rds("./model_full_rstan_var_revised_rand_lag.rds")
```
...
```{r}
county_fit_posterior = my_posterior_predict_rand_lag(fit, evaldata, type="decrease")
...
county_fit_posterior_up = my_posterior_predict_rand_lag(fit, evaldata_up, type="decrease")
...
county_fit_posterior_down = my_posterior_predict_rand_lag(fit, evaldata_down, type="decrease")
